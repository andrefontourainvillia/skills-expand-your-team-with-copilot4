...
def get_activities(
    ...
    - difficulty_level: Filter activities by difficulty level ('Beginner', 'Intermediate', 'Advanced', or 'all' for activities without a level)
    """
